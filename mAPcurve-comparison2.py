...
if __name__ == '__main__':
    ...
    result_dict = {
        'YOLOv8n': r'D:/ultralytics-main/runs/detect/train15/results.csv',
        'YOLOv8n-SPPELAN-SCDown': r'D:/ultralytics-main/runs/detect/train92/results.csv',
        'YOLOv8n-SPPELAN-SCDown-DWS': r'D:/ultralytics-main/runs/detect/train107/results.csv',
        'YOLOv8n-SDD': r'D:/ultralytics-main/runs/detect/train122/results.csv',
        'YOLOv8n-SDD-DetectP': r'D:/ultralytics-main/runs/detect/train158/results.csv',
        'YOLOv8n-SDD-DetectP-MPDIou': r'D:/ultralytics-main/runs/detect/train163/results.csv',
    }
