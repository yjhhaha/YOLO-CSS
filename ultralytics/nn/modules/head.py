...
class Detect(nn.Module):
    ...
    def __init__(self, nc=80, ch=()):
        ...
        # self.cv2 = nn.ModuleList(
        #     nn.Sequential(PConv(x, c2), Conv(c2, c2, 1), nn.Conv2d(c2, 4 * self.reg_max, 1)) for x in ch
        # )
        ...
        #     for x in ch
        # )
        # self.cv3 = nn.ModuleList(nn.Sequential(PConv(x, c3), Conv(c3, c3, 1), nn.Conv2d(c3, self.nc, 1)) for x in ch)  #Detect-P
        # self.cv3 = nn.ModuleList(
        #     nn.Sequential(
