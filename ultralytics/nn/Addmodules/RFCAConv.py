...
class RFCAConv(nn.Module):
    def __init__(self, inp, oup, kernel_size=3, stride=1, reduction=32):
        ...
        self.conv = nn.Sequential(nn.Conv2d(inp, oup, kernel_size=kernel_size, stride=kernel_size))
...
class C2f_RFCAConv(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        ...
        self.m = nn.ModuleList(
            Bottleneck_RFCAConv(self.c, self.c, shortcut, g, k=((3, 3), (3, 3)), e=1.0) for _ in range(n))
